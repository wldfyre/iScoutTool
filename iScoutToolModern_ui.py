...
"}")
        ...
        self.statusLayout.setContentsMargins(-1, 0, -1, -1)
        ...
        self.statusLayout.addWidget(self.lblTimer)
        ...
        self.statusLayout.addWidget(self.btnResetTimer)
        ...
        self.tableToolbar.addItem(spacerItem1)
